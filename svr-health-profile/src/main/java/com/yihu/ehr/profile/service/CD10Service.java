...
public class CD10Service {
    ...
    public List<MDrugDict> getDrugDictList(String problemCode){
        ...
        List<MHpIcd10Relation> hpIcd10Relations = hpIcd10RelationClient.getHpIcd10RelationByHpId(healthProblemDictId);

        //获取ICD10id列表
        List<String> icd10Ids = new ArrayList<>();
        for (MHpIcd10Relation hpIcd10Relation : hpIcd10Relations){
    ...
    public List<MIcd10Dict> getIcd10DictList(String problemCode) {
        ...
        List<MHpIcd10Relation> hpIcd10RelationList = hpIcd10RelationClient.getHpIcd10RelationByHpId(hpId);
        List<String> icd10Ids = new ArrayList<>();
        for (MHpIcd10Relation h: hpIcd10RelationList){
