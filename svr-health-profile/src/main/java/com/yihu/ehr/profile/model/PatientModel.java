...
public class PatientModel {
    ...
    String currentResidenceZipCode;
    String ABOBloodGroup;
    String RhBloodGroup;
    ...
    public String getCurrentResidenceZipCode() {
        return currentResidenceZipCode;
    }

    public void setCurrentResidenceZipCode(String currentResidenceZipCode) {
        this.currentResidenceZipCode = currentResidenceZipCode;
    }
