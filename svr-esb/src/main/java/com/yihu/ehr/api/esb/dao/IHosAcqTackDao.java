 ...
 */
public interface IHosAcqTackDao extends PagingAndSortingRepository<HosAcqTask, String> {
    @Query("select e from HosAcqTask e where e.systemCode = :systemCode and e.orgCode= :orgCode and e.status='0' order by e.createTime asc")
