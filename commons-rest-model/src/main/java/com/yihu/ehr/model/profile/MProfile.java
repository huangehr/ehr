...
public class MProfile {
    ...
    private Map<String, MProfileDataSet> dataSets;
    ...
    public Collection<MProfileDataSet> getDataSets() {
    ...
    public void addDataSet(String dataSetCode, MProfileDataSet dataSet) {
    ...
    public MProfileDataSet getDataSet(String dataSetCode) {
    ...
    public String toJson(){
        ...
        for (String dataSetCode : dataSets.keySet()){
            MProfileDataSet dataSet = dataSets.get(dataSetCode);
