...
import com.yihu.ehr.profile.memory.extractor.EventExtractor;
...
public class MemoryProfile {
    ...
    @Column(value = ProfileFamily.BasicColumns.ProfileType, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.EventType, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.CdaVersion, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.CardId, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.OrgCode, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.PatientId, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.EventNo, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.DemographicId, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.EventDate, family = ProfileFamily.Basic)
    ...
    @Column(value = ProfileFamily.BasicColumns.CreateDate, family = ProfileFamily.Basic)
