...
public interface OrganizationClient {
    ...
    OrgModel getOrg(@PathVariable(value = "org_code") String orgCode);

    @RequestMapping(value = ApiVersion.Version1_0 + "/organizations/admin/{admin_login_code}", method = GET)
    OrgModel getOrgByAdminLoginCode(@PathVariable(value = "admin_login_code") String adminLoginCode);

    @RequestMapping(value = ApiVersion.Version1_0 + "/organizations", method = GET)
    List<OrgModel> search(
