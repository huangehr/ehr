...
public class AuthorizationsEndPoint {
    ...
    @RequestMapping(value = "/{token_id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/{token_id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/{token_id}", method = RequestMethod.DELETE)
