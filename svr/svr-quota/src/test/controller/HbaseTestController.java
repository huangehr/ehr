...
import com.yihu.quota.service.quota.HbaseService;
...
public class HbaseTestController extends BaseController {
    ...
    public List<Map<String,Object>> selectData(
        ...
        try {
            return  hbaseService.selectData(id);
        } catch (Exception e) {
            error(e);
    ...
    public static class StatisticsController extends BaseController {
