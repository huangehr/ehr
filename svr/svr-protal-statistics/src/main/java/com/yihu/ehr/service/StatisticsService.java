...
public class StatisticsService {
    ...
    public void generateTotalReportSheet(HSSFWorkbook wb, String date) throws Exception {
        ...
        if (reportData != null && reportData.size() > 0) {
            ...
            for (String key : keys) {
                ...
                String orgName = redisClient.get(orgKeySchema.get(key));
    ...
    public void generateOrgReportSheets(HSSFWorkbook wb, String date) throws Exception {
        ...
        if (facetField != null && facetField.getValues() != null) {
            ...
            for (FacetField.Count count : counts) {
                String orgName = redisClient.get(orgKeySchema.get(count.getName()));
    ...
    public void generateOrgReportSheet(HSSFWorkbook wb, HSSFSheet sheet, String orgCode, String date) throws Exception {
        ...
        String orgName = redisClient.get(orgKeySchema.get(orgCode));
