...
import com.yihu.ehr.adaption.dao.OrgAdapterPlanRepository;
 ...
 */
@Service
public class OrgAdapterPlanService extends BaseJpaService<OrgAdapterPlan, OrgAdapterPlanRepository> {
