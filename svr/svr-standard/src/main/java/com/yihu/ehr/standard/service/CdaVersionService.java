...
import com.yihu.ehr.standard.config.StdHibernateConfig;
import com.yihu.ehr.standard.config.StdSessionFactoryBean;
import com.yihu.ehr.standard.dao.CdaVersionRepository;
 ...
 */
@Service
public class CdaVersionService extends BaseJpaService<CDAVersion, CdaVersionRepository> {
    public static final String FBVersion = "000000000000";

    @Autowired
    private StdSessionFactoryBean sessionFactory;
