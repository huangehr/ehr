...
import com.yihu.ehr.standard.dao.CdaTypeRepository;
...
@Transactional
@Service
public class CdaTypeService extends BaseJpaService<CDAType, CdaTypeRepository> {


    public CdaTypeRepository getXcdaTypeRepository(){
       return (CdaTypeRepository) getRepository();
   }
