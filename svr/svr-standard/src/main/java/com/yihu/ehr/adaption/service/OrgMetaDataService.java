...
import com.yihu.ehr.adaption.dao.OrgMetaDataRepository;
 ...
 */
@Service
public class OrgMetaDataService extends BaseJpaService<OrgMetaData, OrgMetaDataRepository> {
    ...
    public boolean isExistOrgMetaData(int orgDataSetSeq, String orgCode, String code) {
        return ((OrgMetaDataRepository) getRepository()).isExistOrgMetaData(orgDataSetSeq, orgCode, code).size() != 0;
    }
    ...
    {
        return ((OrgMetaDataRepository) getRepository()).getMetaDataBySequence(orgCode,sequence);
    }
}
