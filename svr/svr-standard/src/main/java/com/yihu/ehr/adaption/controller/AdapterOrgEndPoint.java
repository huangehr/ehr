...
import com.yihu.ehr.adaption.service.AdapterOrgService;
...
@Api(value = "AdapterOrgEndPoint", description = "第三方标准", tags = {"适配服务-第三方标准"})
public class AdapterOrgEndPoint extends ExtendEndPoint<MAdapterOrg> {
    @Autowired
