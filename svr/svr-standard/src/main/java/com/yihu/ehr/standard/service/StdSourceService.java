...
import com.yihu.ehr.standard.dao.StdSourceRepository;
...
@Service
@Transactional
public class StdSourceService extends BaseJpaService<StandardSource, StdSourceRepository> {

    @Autowired
    private StdSourceRepository standardSourceRepository;
