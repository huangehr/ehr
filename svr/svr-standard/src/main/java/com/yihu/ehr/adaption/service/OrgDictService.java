...
import com.yihu.ehr.adaption.dao.OrgDictRepository;
 ...
 */
@Service
public class OrgDictService extends BaseJpaService<OrgDict, OrgDictRepository> {
    ...
    public boolean isExistOrgDict(String orgCode, String code) {
        return ((OrgDictRepository) getRepository()).isExistOrgDict(orgCode, code).size() != 0;
    }
    ...
    {
        return ((OrgDictRepository) getRepository()).getOrgDictBySequence(orgCode, sequence);
    }
}
