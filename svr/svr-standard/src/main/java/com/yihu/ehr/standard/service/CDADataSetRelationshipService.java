...
import com.yihu.ehr.standard.model.BaseCDADataSetRelationship;
import com.yihu.ehr.standard.model.BaseCDADocument;
import com.yihu.ehr.standard.model.CDADataSetRelationship;
 ...
 */
@Service
public class CDADataSetRelationshipService extends BaseHbmService<BaseCDADataSetRelationship> {
    ...
    private final static String ENTITY_PRE = "com.yihu.ehr.standard.model.CDADataSetRelationship";
    ...
    public Class getDocumentServiceEntity(String version) {
        try {
            return Class.forName("com.yihu.ehr.standard.model.CDADocument" + version);
        } catch (ClassNotFoundException e) {
