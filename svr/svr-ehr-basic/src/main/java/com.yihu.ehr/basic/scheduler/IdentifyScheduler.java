package com.yihu.ehr.basic.scheduler;
...
import com.yihu.ehr.basic.report.service.QcDailyStatisticsService;
...
public class IdentifyScheduler {
	...
	@Autowired
	private QcDailyStatisticsService qcDailyStatisticsService;
