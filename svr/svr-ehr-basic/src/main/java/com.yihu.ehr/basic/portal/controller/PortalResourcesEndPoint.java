...
import com.yihu.ehr.basic.portal.service.ItResourceDownloadService;
...
public class PortalResourcesEndPoint extends EnvelopRestEndPoint {
    ...
    @Autowired
    ItResourceDownloadService portalResourcesService;
    ...
    public List<MPortalResources> getAllPortalResources(){
        List<ItResourceDownload> list = portalResourcesService.getAllPortalResources();
    ...
    public List<MPortalResources> searchPortalResources(
        ...
        List<ItResourceDownload> portalResourcesList = portalResourcesService.search(fields, filters, sorts, page, size);
    ...
    public MPortalResources getPortalResources(
        ...
        ItResourceDownload portalResources = portalResourcesService.getPortalResources(portalResourcesId);
