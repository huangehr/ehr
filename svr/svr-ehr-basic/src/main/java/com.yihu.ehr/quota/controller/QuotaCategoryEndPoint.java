...
import com.yihu.ehr.quota.service.QuotaCategoryService;
...
public class QuotaCategoryEndPoint extends EnvelopRestEndPoint {
    @Autowired
    ...
    public ListResult getQuotaCategoryList(
        ...
        List<QuotaCategory> quotaCategoryList = quotaCategoryService.search(fields, filters, sorts, page, size);
    ...
    public List<MQuotaCategory> getAllQuotaCategory() throws Exception {
        List<QuotaCategory> quotaCategories = quotaCategoryService.getAllQuotaCategory();
    ...
    public List<MQuotaCategory> searchChildQuotaCategory(
        ...
        List<QuotaCategory> quotaCategories = quotaCategoryService.searchByParentId(parentId);
        return (List<MQuotaCategory>) convertToModels(quotaCategories, new ArrayList<MQuotaCategory>(quotaCategories.size()), MQuotaCategory.class, null);
    }
    ...
    public MQuotaCategory searchQuotaCategoryDetail(
        ...
        QuotaCategory quotaCategory = quotaCategoryService.getById(id);
    ...
    public MQuotaCategory saveQuotaCategory(
        ...
        try {
            QuotaCategory quotaCategory = toEntity(jsonData, QuotaCategory.class);
    ...
    public List<MQuotaCategory> getQuotaCategoryOfChild() {
        List<QuotaCategory> quotaCategories = quotaCategoryService.getQuotaCategoryOfChild();
        return (List<MQuotaCategory>) convertToModels(quotaCategories, new ArrayList<MQuotaCategory>(quotaCategories.size()), MQuotaCategory.class, null);
    }
    ...
    public List<MQuotaCategory> getQuotaCategoryChild() {
        List<QuotaCategory> quotaCategories = quotaCategoryService.getQuotaCategoryChild();
        return (List<MQuotaCategory>) convertToModels(quotaCategories, new ArrayList<MQuotaCategory>(quotaCategories.size()), MQuotaCategory.class, null);
    }
