...
public class StringUtil {
    ...
    /**
     * ***************************************************** ?? ??????????????????"0"
     * ????????param str:???????????? param counter??????????? ?? ???Stirng <p/> ??ß’????? ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ????ßÿ??????????????????null????(???????)?? ????????param str:???ßÿ??????? ????????? ??
     * ???true?????false????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ?? ????ßÿ?????????????????????
     * ????????param text:???ßÿ?????????param len:????????? ????????? ?? ???return
     * true??¶ƒ??????false??????????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ????ßÿ??????????????????????????? ????????param text:???ßÿ?????????param len:????????? ????????? ??
     * ???return true??¶ƒ??????false??????????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ????ßÿ???????????????english ????????param text:???ßÿ????????? ????????? ?? ???return
     * true???????false:????????????????????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ?? ????ßÿ????????????????
     * ????????param ch:???ßÿ????? ????????? ?? ???return true???????false:?????? <p/>
     * ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ????ßÿ?????????????ßŸ????????? ????????param str:???ßÿ??????? ????????? ?? ???return
     * true??Null?????????????false:??????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ?? ????ßÿ?????????????????????
     * ????????param str:???ßÿ??????? ????????? ?? ???return true??NULL???ßŸ?????????false:?????????
     * <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ?? ????????? ????????param
     * str1:???????????????param sindex:???¶À???param eindex:????¶À?? ????????? ??
     * ???????????¶À????????¶À???????????????????¶À??ß≥??0?????????¶À????????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ?? ????????????ùI????
     * ????????param strSource ???ùI?????????param strFrom ????????param strTo ???????? ????????? ??
     * ????ùI???????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ????ßÿ????????????????ß⁄?????? ????????param str1 ?????????????param strarray ??????????????ÔÖ
     * ????????? ?? ???return true??????;false??¶ƒ???? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ?????????ß’?????????ß≥????¶À?????????????ß≥????¶À?????????¶À???? ????????param amount ???????, param
     * length ?????ß≥??¶À???? ????????? ?? ???return ??????????????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    public static String[] doSplit(String str, char chr) {
        ...
        for (int i = 0; i < iCount; i++) {
            ...
            str = str.substring(iPos + 1); // ??iPos+1??????,str????????ß≥
        }
        return strArray;
    }
    ...
    /**
     * ***************************************************** ??
     * ???????strSeparator?????????????????????ß≥??????? ????????param strToSplit ??????????,param
     * strSeparator ????????,param iLimit ?????ß≥ ????????? ?? ???return String[] ??????????????
     * <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ????????????ß≥????????????????????...???? ????????param src ???????????,param len ?????ß≥ ????????? ??
     * ???return String ??ß≥????????????????????...??????????? <p/> ??ß’?????20051220 ???????
     * ******************************************************
     */
    ...
    /**
     * ***************************************************** ??
     * ????ßÿ?????????????????STaaaa????ST****** ????????param strSource???????????????param
    ...
    public static String getFirstLetter(String chinese) {
        ...
        if (chinese.length() > 1) { // ?ßÿ?????????
            int li_SectorCode = (int) chinese.charAt(0); // ????????
            int li_PositionCode = (int) chinese.charAt(1); // ????¶À??
            li_SectorCode = li_SectorCode - 160;
            li_PositionCode = li_PositionCode - 160;
            int li_SecPosCode = li_SectorCode * 100 + li_PositionCode;// ??????¶À??
