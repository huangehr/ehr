    ...
    <div class="m-form-group f-ml100 f-w500">
        ...
        <div class="l-text-wrapper m-form-control essential">
            <input type="password" id="inp_new_passWord"
                   class="required useTitle ajax length-range-8-16 validate-space validate-special-char" required-title=
                   <spring:message code="lbl.must.input"/> data-attr-scan="newPassWord"/>
        </div>
    </div>
    <div class="m-form-group f-ml100 f-w500">
        <label></label>
