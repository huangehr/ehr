...
<div id="div_organization_info_form" data-role-form="" class="m-form-inline f-mt20" data-role-form style="overflow:auto">
    ...
    <div class="m-form-group">
        ...
        <div class="l-text-wrapper m-form-control">
            <input type="text" id="location" class="f-w240 validate-special-char" data-type="comboSelect" required-title=<spring:message code="lbl.must.input"/> data-attr-scan="location" maxlength="200"/>
        </div>
    </div>
