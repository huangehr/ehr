...
define(function (require, exports, module) {
    ...
    var jQuery = require('jquery'),
        Tips = require('modules/tips/tips'),
        Util = require('utils');
    ...
    (function($){
        ...
        jValidation.util = {
            ...
            getFormElements: function(jForm){
                return jForm.find(":text,:password,:radio.validate-one-required,:checkbox[class*=checkbox-required],select,textarea");
            },
    ...
    (function(Validation, $){
         ...
         */
            ...
            ['validate-mobile-phone',/^0?(13[0-9]|15[012356789]|18[012356789]|14[57])[0-9]{8}$/],
