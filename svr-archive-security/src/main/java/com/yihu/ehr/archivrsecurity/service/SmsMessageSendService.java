...
@Service
@Transactional
public class SmsMessageSendService extends BaseJpaService<SmsMessageSend, XSmsMessageSendRepository> {

    @Autowired
    XSmsMessageSendRepository smsMessageSendRepository;
    public boolean updateStatus(long id, int status) {
        smsMessageSendRepository.updateStatus(id,status);
        return true;
    }
}
