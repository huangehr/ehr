...
public class StdSourceType implements Serializable {
    ...
    public StdSourceType(){

    }
    public StdSourceType(long dictId, String code, String value, Integer sort, String phoneticCode, String catalog){
        this.dictId = dictId;
        this.code = code;
        this.value = value;
        this.sort = sort;
