...
@Api(protocols = "https", value = "conventional_dict", description = "惯用字典接口，对于常见的字典可直接获取字典项", tags = {"惯用字典接口"})
public class ConventionalDictController extends BaseRestController {
    ...
    @RequestMapping(value = "/conventional_dict/app_catalog", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/app_status", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/gender", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/martial_status", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/nation", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/residence_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/org_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/settled_way", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/card_status", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/card_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/request_state", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/key_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/medical_role", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/user_role", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/user_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/3rd_app", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/yes_no", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/adaption_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/std_source_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/std_source_types", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/conventional_dict/user_types", method = RequestMethod.GET)
    @ApiOperation(value = "获取用户类型字典项", response = MConventionalDict.class, produces = "application/json")
    ...
    @RequestMapping(value = "/conventional_dict/tags", method = RequestMethod.GET)
