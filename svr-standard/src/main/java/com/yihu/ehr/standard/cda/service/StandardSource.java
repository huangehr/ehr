package com.yihu.ehr.standard.cda.service;//package com.yihu.ehr.standard.standardsource.service;
...
public class StandardSource {
    ...
    public int getHashCode() {
        hashCode = Objects.hash(code, create_date, create_user, description, id, name, updateDate, updateUser, sourceType);
        return hashCode;
    }
