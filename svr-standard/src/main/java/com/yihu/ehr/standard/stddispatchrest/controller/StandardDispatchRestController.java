...
public class StandardDispatchRestController extends BaseRestController {
    ...
    private StdDispatchManager stdSendManager;
    ...
    @ApiOperation(value = "获取适配方案摘要", response = RestEcho.class, produces = "application/json", notes = "获取两个指定版本的标准化数据差异与适配方案，文件以Base64编码，压缩格式为zip")
