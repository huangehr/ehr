...
@Transactional
@Service
public class MetaDataManager extends SQLGeneralDAO {
    ...
    private MetaData recordToMetaData(DataSet dataSet, Object[] record){
        ...
        metaData.setDict_name(record[15] == null ? "" : record[15].toString());
        metaData.setDict_code(record[16] == null ? "" : record[16].toString());
        return metaData;
    }
    ...
    @Transactional(Transactional.TxType.SUPPORTS)
    public Integer getCountByCode(String versioncode,String strCode,String strSetId) {
