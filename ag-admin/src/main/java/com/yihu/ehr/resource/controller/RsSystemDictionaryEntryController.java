...
public class RsSystemDictionaryEntryController extends BaseController {
    ...
    public List<MRsSystemDictionaryEntry> searchRsSystemDictionaryEntries(
        ...
        return rsSystemDictionaryEntryClient.searchRsSystemDictionaryEntries(fields,filters,sorts,size,page);
    }
    ...
    public MRsSystemDictionaryEntry createRsSystemDictionaryEntry(
        ...
        return rsSystemDictionaryEntryClient.createRsSystemDictionaryEntry(jsonData);
    }
    ...
    public MRsSystemDictionaryEntry updateRsSystemDictionaryEntry(
            ...
            @RequestBody String jsonData) throws Exception {
        return rsSystemDictionaryEntryClient.updateRsSystemDictionaryEntry(jsonData);
    }
    ...
    public boolean deleteRsSystemDictionaryEntry(
        ...
        return rsSystemDictionaryEntryClient.deleteRsSystemDictionaryEntry(id);
    }
