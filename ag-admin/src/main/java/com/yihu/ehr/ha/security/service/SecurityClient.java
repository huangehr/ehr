...
public interface SecurityClient {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/api/v1.0/securities/{user_id}", method = RequestMethod.POST)
     ...
     * @return
     */
    @RequestMapping(value = "/api/v1.0/securities/user/{user_id}", method = RequestMethod.GET)
