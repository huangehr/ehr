...
public interface OrgDictClient {
    @RequestMapping(value = "/org_dict", method = RequestMethod.GET)
    @ApiOperation(value = "根据id查询实体")
    MOrgDict getOrgDict(
            @ApiParam(name = "id", value = "查询条件", defaultValue = "")
            @RequestParam(value = "id", required = false) long id);

    @RequestMapping(value = "/org_dict", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/org_dict/{id}", method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/org_dict/{id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/org_dicts", method = RequestMethod.GET)
    @ApiOperation(value = "条件查询")
    Collection<MOrgDict> searchOrgDicts(
    ...
    @RequestMapping(value = "/org_dict/combo", method = RequestMethod.GET)
