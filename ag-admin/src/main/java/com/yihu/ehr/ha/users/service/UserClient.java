...
public interface UserClient {
    ...
    @RequestMapping(value = "/api/v1.0/users" , method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/users/{user_id}" , method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/api/v1.0/users" , method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/api/v1.0/users" , method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/api/v1.0/users/{user_id}" , method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/users/{user_id}/{activity}" , method = RequestMethod.PUT)
    ...
    boolean  activityUser (
            ...
            @PathVariable(value = "activity") boolean activity) ;


    @RequestMapping(value = "/api/v1.0/users/password/{user_id}" , method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/api/v1.0/users/binding/{user_id}/{type}" , method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/api/v1.0/users/key/{login_code}", method = RequestMethod.PUT)
     ...
     * @param psw
     */
    @RequestMapping(value = "/api/v1.0/users/verification/{login_code}/{psw}" , method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/api/v1.0/users/login/{login_code}" , method = RequestMethod.GET)
