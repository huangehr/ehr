...
public class ConventionalDictEntryController {
    ...
    public MConventionalDict getAppCatalog(
        ...
        return dictEntryClient.getAppCatalog(code);
    }
    ...
    public MConventionalDict getAppStatus(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getAppStatus(code);
    }
    ...
    public MConventionalDict getGender(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getGender(code);
    }
    ...
    public MConventionalDict getMartialStatus(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getMartialStatus(code);
    }
    ...
    public MConventionalDict getNation(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getNation(code);
    }
    ...
    public MConventionalDict getResidenceType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getResidenceType(code);
    }
    ...
    public MConventionalDict getOrgType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getOrgType(code);
    }
    ...
    public MConventionalDict getSettledWay(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getSettledWay(code);
    }
    ...
    public MConventionalDict getCardStatus(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getCardStatus(code);
    }
    ...
    public MConventionalDict getCardType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getCardType(code);
    }
    ...
    public MConventionalDict getRequestState(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getRequestState(code);
    }
    ...
    public MConventionalDict getKeyType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getKeyType(code);
    }
    ...
    public MConventionalDict getMedicalRole(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getMedicalRole(code);
    }
    ...
    public MConventionalDict getUserRole(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getUserRole(code);
    }
    ...
    public MConventionalDict getUserType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getUserType(code);
    }
    ...
    public MConventionalDict getLoginAddress(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getLoginAddress(code);
    }
    ...
    public MConventionalDict getYesNo(
        ...
        return dictEntryClient.getYesNo(code);
    }
    ...
    public MConventionalDict getAdapterType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getAdapterType(code);
    }
    ...
    public MConventionalDict getStdSourceType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code) {
        return dictEntryClient.getStdSourceType(code);
    }
    ...
    public List<MConventionalDict> getStdSourceTypeList(
        ...
        return dictEntryClient.getStdSourceTypeList(codes);
    }
