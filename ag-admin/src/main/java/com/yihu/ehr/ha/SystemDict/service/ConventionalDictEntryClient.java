...
public interface ConventionalDictEntryClient {
    ...
    @RequestMapping(value = "/api/v1.0/dictionaries/app_catalog", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/dictionaries/app_status", method = RequestMethod.GET)
    @ApiOperation(value = "获取应用状态字典项", response = MConventionalDict.class, produces = "application/json")
    MConventionalDict getAppStatus(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code);

    @RequestMapping(value = "/api/v1.0/dictionaries/gender", method = RequestMethod.GET)
    @ApiOperation(value = "获取性别字典项", response = MConventionalDict.class, produces = "application/json")
    MConventionalDict getGender(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code);

    @RequestMapping(value = "/api/v1.0/dictionaries/martial_status", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/dictionaries/nation", method = RequestMethod.GET)
    @ApiOperation(value = "获取国家字典项", response = MConventionalDict.class, produces = "application/json")
    MConventionalDict getNation(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code);

    @RequestMapping(value = "/api/v1.0/dictionaries/residence_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/dictionaries/yes_no", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/dictionaries/adaption_type", method = RequestMethod.GET)
    @ApiOperation(value = "获取适配类型字典项", response = MConventionalDict.class, produces = "application/json")
    MConventionalDict getAdapterType(
            @ApiParam(name = "code", value = "字典代码", defaultValue = "")
            @RequestParam(value = "code") String code);

    @RequestMapping(value = "/api/v1.0/dictionaries/std_source_type", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/dictionaries/std_source_types", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/v1.0/dictionaries/user_types", method = RequestMethod.GET)
    @ApiOperation(value = "获取用户类型字典项", response = MConventionalDict.class, produces = "application/json")
    Collection<MConventionalDict> getUserTypeList();

    @RequestMapping(value = "/api/v1.0/dictionaries/tags", method = RequestMethod.GET)
