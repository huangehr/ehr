...
import com.yihu.ehr.adaption.service.AdapterOrgModel;
...
@Api(protocols = "https", value = "adapterorg", description = "采集标准管理接口", tags = {"采集标准"})
...
//        return result.toJson();
    ...
    public Object addAdapterOrg(AdapterOrgModel adapterOrgModel){
//        Result result = new Result();
//        try {
