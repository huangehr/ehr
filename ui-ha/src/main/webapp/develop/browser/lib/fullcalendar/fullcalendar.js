...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	renderNumberTrHtml: function(row) {
		//debugger
		var a = this.isRTL ? '' : this.renderNumberIntroHtml(row);
		var b= this.renderNumberCellsHtml(row);
		var c = this.isRTL ? this.renderNumberIntroHtml(row) : '';
		return '' +
			'<tr>' +
...
DayGrid.mixin({
	...
	renderFgSegs: function(segs) {
		...
		this.rowEls.each(function(i, rowNode) {
			debugger
			$(rowNode).find('.fc-content-skeleton > table').prepend(
