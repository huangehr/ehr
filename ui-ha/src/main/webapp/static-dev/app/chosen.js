...
define(function (require, exports, module) {
    ...
    var infoTpl =   '<div class="modal fade attach-card-modal msg-modal" id="attachCardModal" tabindex="0"role="dialog" aria-labelledby="confirmModalLabel"> ' +
    ...
    var infoBoxTpl = '<div class="modal fade f-pl30 f-pt30" id="searchCardDetail" tabindex="-1" role="dialog" aria-labelledby="searchCardDetailLabel">' +
    ...
    function initSelect(dictId,target){
        /*下拉框的方法*/
        var target = $(target);
        $.ajax({
            ...
            success:function(data){
                ...
                for(var i=0;i<data.detailModelList.length;i++){
                    option +='<option value='+data.detailModelList[i].id.code+'>'+data.detailModelList[i].value+'</option>';
                }
        ...
        $(function () {
            ...
            grid = new Grid('#grid-search-card',{
                ...
                colModel:[
                    ...
                    {name:'order',index:'order',sorttype: 'int', width:50,  align: "center" },
                    {name:'type',index:'type',hidden:true, width:56, align:"center"},
                    {name:'typeValue',index:'typeValue', width:106, align:"center"},
                    {name:'number',index:'number', width:122, align:"center"},
