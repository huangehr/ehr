...
<script type="text/javascript">
  ...
  (function ($, win) {
    ...
    var versions;
    var types;
    var adapterPlan = $.parseJSON('${adapterPlan}');
...
/*                    self.$org.ligerComboBox(
        ...
        function searchParent(){
            self.$parent.ligerComboBox(
                    {
                        url: '${contextRoot}/adapter/getAdapterPlanList',
                        valueField: 'code',
                        textField: 'value',
                        dataParmName: 'detailModelList',
                        urlParms: {
      ...
      bindEvents: function () {
          ...
          if(!validator.validate()){
            ...
            if(pv){
                ...
                $.Notice.confirm("映射机构采集标准与复方案采集标准不一致，是否覆盖映射机构采集标准？", function (r) {
                    adapterPlanModel.isCover = r;
                    updata(adapterPlanModel);
                })
            }
          else{
            updata(adapterPlanModel);
        ...
        function updata(adapterPlanModel){
          ...
          dataModel.createRemote("${contextRoot}/adapter/updateAdapterPlan", {
