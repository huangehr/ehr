...
@RestController
@Api( value = "QcQuotaDict", description = "数据统计指标", tags = {"报表管理-数据统计指标"})
public class QcQuotaDictController extends ExtendController<QcQuotaDict> {

    @Autowired
    QcQuotaDictClient qcQuotaDictClient;
    ...
    @RequestMapping(value = ServiceApi.Report.QcQuotaDict, method = RequestMethod.POST)
