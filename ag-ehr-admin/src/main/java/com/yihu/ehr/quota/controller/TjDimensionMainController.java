...
import com.yihu.ehr.quota.service.TjDimensionMainClient;
import com.yihu.ehr.quota.service.TjQuotaDimensionMainClient;
...
public class TjDimensionMainController extends ExtendController<TjDimensionMain> {
    ...
    public List TjDimensionMainIsExist(
        ...
        return tjDimensionMainClient.tjDimensionMainIsExist(mainCode);
    }
}
