...
public class THBaseTable implements org.apache.thrift.TBase<THBaseTable, THBaseTable._Fields>, java.io.Serializable, Cloneable, Comparable<THBaseTable> {
  ...
  private static final org.apache.thrift.protocol.TField META_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("metaData", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  private static final _Fields optionals[] = {_Fields.META_DATA};
  ...
  public THBaseTable setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public THBaseTable setMetaData(String metaData) {
