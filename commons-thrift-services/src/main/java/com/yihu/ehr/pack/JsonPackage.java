...
public class JsonPackage implements org.apache.thrift.TBase<JsonPackage, JsonPackage._Fields>, java.io.Serializable, Cloneable, Comparable<JsonPackage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("JsonPackage");
  ...
  static {
    schemes.put(StandardScheme.class, new JsonPackageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new JsonPackageTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(JsonPackage.class, metaDataMap);
  }
   ...
   */
  public JsonPackage(JsonPackage other) {
  ...
  public JsonPackage deepCopy() {
    return new JsonPackage(this);
  }
  ...
  public JsonPackage setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public JsonPackage setPwd(String pwd) {
    this.pwd = pwd;
    return this;
  }
  ...
  public JsonPackage setRemotePath(String remotePath) {
    this.remotePath = remotePath;
    return this;
  }
  ...
  public JsonPackage setUserId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public JsonPackage setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public JsonPackage setReceiveDate(String receiveDate) {
    this.receiveDate = receiveDate;
    return this;
  }
  ...
  public JsonPackage setParseDate(String parseDate) {
    this.parseDate = parseDate;
    return this;
  }
  ...
  public JsonPackage setFinishDate(String finishDate) {
    this.finishDate = finishDate;
    return this;
  }
  ...
  public JsonPackage setArchiveStatus(int archiveStatus) {
    this.archiveStatus = archiveStatus;
    setArchiveStatusIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof JsonPackage)
      return this.equals((JsonPackage)that);
    return false;
  }

  public boolean equals(JsonPackage that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(JsonPackage other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JsonPackage(");
    boolean first = true;
  ...
  private static class JsonPackageStandardSchemeFactory implements SchemeFactory {
    public JsonPackageStandardScheme getScheme() {
      return new JsonPackageStandardScheme();
    }
  }

  private static class JsonPackageStandardScheme extends StandardScheme<JsonPackage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, JsonPackage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JsonPackage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class JsonPackageTupleSchemeFactory implements SchemeFactory {
    public JsonPackageTupleScheme getScheme() {
      return new JsonPackageTupleScheme();
    }
  }

  private static class JsonPackageTupleScheme extends TupleScheme<JsonPackage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, JsonPackage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, JsonPackage struct) throws org.apache.thrift.TException {
