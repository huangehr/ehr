...
public class JsonPackageManager {
  ...
  public interface Iface {
     ...
     * @param to
     */
    public List<JsonPackage> getArchiveList(String since, String to) throws org.apache.thrift.TException;
     ...
     * @param conditions
     */
    public List<JsonPackage> searchArchives(Map<String,String> conditions) throws org.apache.thrift.TException;
     ...
     * @param id
     */
    public JsonPackage getJsonPackage(String id) throws org.apache.thrift.TException;
     ...
     * @return 档案的存储路径.
     */
    public JsonPackage acquireArchive() throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<JsonPackage> recv_getArchiveList() throws org.apache.thrift.TException
    {
    ...
    public List<JsonPackage> recv_searchArchives() throws org.apache.thrift.TException
    {
    ...
    public JsonPackage recv_getJsonPackage() throws org.apache.thrift.TException
    {
    ...
    public JsonPackage recv_acquireArchive() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getArchiveList_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<JsonPackage> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class getJsonPackage_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public JsonPackage getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getArchiveList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getArchiveList_args, List<JsonPackage>> {
      public getArchiveList() {
        super("getArchiveList");
      }
      ...
      public AsyncMethodCallback<List<JsonPackage>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<JsonPackage>>() { 
          public void onComplete(List<JsonPackage> o) {
            getArchiveList_result result = new getArchiveList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getArchiveList_args args, org.apache.thrift.async.AsyncMethodCallback<List<JsonPackage>> resultHandler) throws TException {
        iface.getArchiveList(args.since, args.to,resultHandler);
      }
    }

    public static class searchArchives<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, searchArchives_args, List<JsonPackage>> {
      public searchArchives() {
        super("searchArchives");
      }
      ...
      public void start(I iface, searchArchives_args args, org.apache.thrift.async.AsyncMethodCallback<List<JsonPackage>> resultHandler) throws TException {
        iface.searchArchives(args.conditions,resultHandler);
      }
    }

    public static class getJsonPackage<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getJsonPackage_args, JsonPackage> {
      public getJsonPackage() {
        super("getJsonPackage");
      }
      ...
      public AsyncMethodCallback<JsonPackage> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<JsonPackage>() { 
          public void onComplete(JsonPackage o) {
            getJsonPackage_result result = new getJsonPackage_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getJsonPackage_args args, org.apache.thrift.async.AsyncMethodCallback<JsonPackage> resultHandler) throws TException {
    ...
    public static class acquireArchive<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, acquireArchive_args, JsonPackage> {
      public acquireArchive() {
        super("acquireArchive");
      }
      ...
      public void start(I iface, acquireArchive_args args, org.apache.thrift.async.AsyncMethodCallback<JsonPackage> resultHandler) throws TException {
  ...
  public static class getArchiveList_result implements org.apache.thrift.TBase<getArchiveList_result, getArchiveList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getArchiveList_result>   {
    ...
    public List<JsonPackage> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, JsonPackage.class))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getArchiveList_result(getArchiveList_result other) {
      if (other.isSetSuccess()) {
        List<JsonPackage> __this__success = new ArrayList<JsonPackage>(other.success.size());
        for (JsonPackage other_element : other.success) {
          __this__success.add(new JsonPackage(other_element));
        }
    ...
    public java.util.Iterator<JsonPackage> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(JsonPackage elem) {
      if (this.success == null) {
        this.success = new ArrayList<JsonPackage>();
      }
      this.success.add(elem);
    }

    public List<JsonPackage> getSuccess() {
      return this.success;
    }

    public getArchiveList_result setSuccess(List<JsonPackage> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<JsonPackage>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<JsonPackage>(_list0.size);
                  JsonPackage _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new JsonPackage();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getArchiveList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (JsonPackage _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (JsonPackage _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<JsonPackage>(_list5.size);
            JsonPackage _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new JsonPackage();
              _elem6.read(iprot);
  ...
  public static class searchArchives_result implements org.apache.thrift.TBase<searchArchives_result, searchArchives_result._Fields>, java.io.Serializable, Cloneable, Comparable<searchArchives_result>   {
    ...
    public searchArchives_result setSuccess(List<JsonPackage> success) {
      this.success = success;
      return this;
    }
    ...
    private static class searchArchives_resultStandardScheme extends StandardScheme<searchArchives_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<JsonPackage>(_list18.size);
                  JsonPackage _elem19;
                  for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                  {
                    _elem19 = new JsonPackage();
                    _elem19.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, searchArchives_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (JsonPackage _iter21 : struct.success)
            {
              _iter21.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class searchArchives_resultTupleScheme extends TupleScheme<searchArchives_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, searchArchives_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (JsonPackage _iter22 : struct.success)
            {
              _iter22.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<JsonPackage>(_list23.size);
            JsonPackage _elem24;
            for (int _i25 = 0; _i25 < _list23.size; ++_i25)
            {
              _elem24 = new JsonPackage();
              _elem24.read(iprot);
  ...
  public static class getJsonPackage_result implements org.apache.thrift.TBase<getJsonPackage_result, getJsonPackage_result._Fields>, java.io.Serializable, Cloneable, Comparable<getJsonPackage_result>   {
    ...
    public JsonPackage success; // required
    ...
    public getJsonPackage_result(getJsonPackage_result other) {
      if (other.isSetSuccess()) {
        this.success = new JsonPackage(other.success);
      }
    }
    ...
    public JsonPackage getSuccess() {
      return this.success;
    }

    public getJsonPackage_result setSuccess(JsonPackage success) {
      this.success = success;
      return this;
    }
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new JsonPackage();
...
;
  ...
  public static class acquireArchive_result implements org.apache.thrift.TBase<acquireArchive_result, acquireArchive_result._Fields>, java.io.Serializable, Cloneable, Comparable<acquireArchive_result>   {
    ...
    public acquireArchive_result setSuccess(JsonPackage success) {
      this.success = success;
      return this;
    }
