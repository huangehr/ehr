...
public class TApp implements org.apache.thrift.TBase<TApp, TApp._Fields>, java.io.Serializable, Cloneable, Comparable<TApp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TApp");
  ...
  private static final org.apache.thrift.protocol.TField CREATE_DATE_FIELD_DESC = new org.apache.thrift.protocol.TField("createDate", org.apache.thrift.protocol.TType.I64, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new TAppStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TAppTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TApp.class, metaDataMap);
  }
  ...
  public TApp setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TApp setCreator(String creator) {
    this.creator = creator;
    return this;
  }
  ...
  public TApp setCreateDate(long createDate) {
    this.createDate = createDate;
    setCreateDateIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TApp)
      return this.equals((TApp)that);
    return false;
  }

  public boolean equals(TApp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TApp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TApp(");
    boolean first = true;
  ...
  private static class TAppStandardSchemeFactory implements SchemeFactory {
    public TAppStandardScheme getScheme() {
      return new TAppStandardScheme();
    }
  }

  private static class TAppStandardScheme extends StandardScheme<TApp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TApp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TApp struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TAppTupleSchemeFactory implements SchemeFactory {
    public TAppTupleScheme getScheme() {
      return new TAppTupleScheme();
    }
  }

  private static class TAppTupleScheme extends TupleScheme<TApp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TApp struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TApp struct) throws org.apache.thrift.TException {
