...
public class ResourcesMetadataQueryDao {
    ...
    {
        String sql = "select a.id,m.domain,m.name,m.code,m.STD_CODE,m.DISPLAY_CODE,m.COLUMN_TYPE,m.NULL_ABLE,m.DICT_CODE,m.DESCRIPTION,m.VALID,a.GROUP_TYPE,a.GROUP_DATA\n" +
