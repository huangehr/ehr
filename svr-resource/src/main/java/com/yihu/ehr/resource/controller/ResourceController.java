...
import com.yihu.ehr.resource.service.ResourceService;
...
@RestController
@RequestMapping(value = ApiVersion.Version1_0 + "/resource")
@Api(value = "resource", description = "资源服务接口")
public class ResourceController {
    ...
    *//**
    ...
    public String getUpdateFlag(
            ...
            @ApiParam("orgCode") @RequestParam(value = "orgCode", required = true) String orgCode) {
        try {
            HosEsbMiniRelease h = resourceService.getUpdateFlag(versionCode, systemCode, orgCode);
            if (h != null) {
    ...
    *//**
    ...
    public String downUpdateWar(
        ...
        try {
            // path是指欲下载的文件的路径。
            HosEsbMiniRelease he = resourceService.getSimplifiedESBBySystemCodes(systemCode, orgCode);
    ...
    *//**
    ...
    public String uploadResult(
        ...
        String hsa = null;
        try {
            hsa = resourceService.uploadResult(systemCode, orgCode, versionCode, versionName, updateDate, message);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return hsa;
    ...
    *//**
    ...
    public String fillMining(
        ...
        String hsa = null;
        try {
            hsa = resourceService.fillMining(systemCode, orgCode);
    ...
    *//**
    ...
    public String changeFillMiningStatus(
        ...
        try {
            resourceService.changeFillMiningStatus(id, message, status);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
    ...
    *//**
    ...
    public String hisPenetration(
        ...
        String returnString = "";
        try {
            HosSqlTask hq = resourceService.hisPenetration(systemCode, orgCode);
            if (hq != null) {
    ...
    *//**
    ...
    public String changeHisPenetrationStatus(
            ...
            @ApiParam("id") @RequestParam(value = "id", required = true) String id) {
        try {
            resourceService.changeHisPenetrationStatus(id, status, result, message);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
