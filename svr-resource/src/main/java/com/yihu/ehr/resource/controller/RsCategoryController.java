...
//    public List<RsCategory> searchRsCategories(
...
//        List<RsDictionary> dictionaries = rsCategoryService.search(fields, filters, sorts, page, size);
//        pagedResponse(request, response, rsCategoryService.getCount(filters), page, size);
//
//        return (List<MRsCategory>) convertToModels(dictionaries, new ArrayList<MRsCategory>(dictionaries.size()), MRsCategory.class, fields);
//    }
//
//
//
...
//        rsCategoryService.save(rsDictionary);
//        return convertToModel(rsDictionary, MRsCategory.class, null);
//
//    }
//
...
//        rsCategoryService.save(hosAcqTask);
//        return convertToModel(hosAcqTask, MRsCategory.class, null);
//    }
//
