 ...
 */
public class QcQuotaResultAnalyseModel {
    ...
    private List<QcQuotaResultDetailModel> qcQuotaResultDetailList;
    ...
    public List<QcQuotaResultDetailModel> getQcQuotaResultDetailList() {
        return qcQuotaResultDetailList;
    }

    public void setQcQuotaResultDetailList(List<QcQuotaResultDetailModel> qcQuotaResultDetailList) {
