...
public class MicroServices {
    ...
    public static final String Package = "svr-pack-mgr-zhoujie";
    ...
    public static final String Statistics = "svr-protal-statistics-zhoujie";
    public static final String Quota = "svr-quota-zhoujie";

    public static final String LogCollection = "svr-logCollection-zhoujie";
}
